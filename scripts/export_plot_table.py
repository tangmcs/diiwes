...
DIAGNOSTIC_FIELDS = [
    ...
    "raw_step_multiplier_min",
    "raw_step_multiplier_max",
    "multiplier_clipping_diagnostics_exact",
    "multiplier_floor_clip_count",
    ...
    "multiplier_ceiling_clip_count",
    "multiplier_ceiling_clip_frac",
    ...
    "curv_max",
    "curv_min",
    "curvature_active_count",
    "curvature_active_frac",
    "curvature_coordinate_count",
    "curvature_preclip_mean",
    "curvature_preclip_max",
    "curvature_clip_count",
    "curvature_clip_frac",
    "curvature_clip_active",
    "curvature_clip_excess_mean",
    "curvature_clip_excess_max",
    "curvature_mode",
    "curvature_step_mode",
    "curvature_baseline",
    "hessian_pairs",
